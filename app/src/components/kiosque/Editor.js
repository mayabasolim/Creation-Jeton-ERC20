                    ...
                    <div className="blog-comments__content">
                      ...
                      <div className="blog-comments__actions">
                        <ButtonGroup size="sm">
                          ...
                          <Button  onClick={() => this.handleShow(prod.id)}  theme="white">
                        ...
                        <Modal show={this.state.show} onHide={this.handleClose}>
                          <Modal.Header closeButton>
                            <Modal.Title>Confirmation d'achat  du produit/service</Modal.Title>
                          </Modal.Header>
                          <Modal.Body>
                          <Row form>

                            <Col md="6" className="form-group">
                            <label htmlFor="feNom">Confirmer l'achat  du produit/service  </label>
                            </Col>
                          </Row>
                          ...
                          <Modal.Footer>
                            ...
                            <Button variant="primary" onClick={() => this._achatKiosque()}>
                              Valider
                            </Button>
                          </Modal.Footer>
                        </Modal>

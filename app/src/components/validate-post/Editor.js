...
class Editor extends React.Component {
  ...
  constructor(props) {
    ...
    this.projets_page = this.props.listePage(this.page_size,this.page_number, this.props.projets)
  ...
  _listePage=(i)=>{
    ...
    if(fin>=this.props.projets.length){
       this.diseableNext=1;
    }
    if(this.page_number===0){
      this.diseablePrev=1;
    }
    this.projets_page =this.props.projets.slice(deb, fin)
    this.forceUpdate();

...
class EditorSol extends React.Component {
  liste_page=[];
  page_size=4;
  page_number=0;
  constructor(props) {
  ...
  _tip=() => {
    ...
    render() {
      ...
      <CardHeader className="border-bottom">
        <h6 className="m-0"> <a  href="projet-favoris"> Projets solutionnés</a></h6>
      </CardHeader>
        ...
        <CardFooter className="border-top">
          <Row>
            <Col className="text-center view-report">
              <a href="projet-favoris">Liste complète &rarr;</a>
            </Col>
          </Row>
        </CardFooter>
      </Card>
